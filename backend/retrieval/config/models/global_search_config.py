...
class GlobalSearchConfig(BaseModel):
    ...
    dynamic_search_max_level: int = Field(
        ...
        default=retrieval_config_defaults.global_search.dynamic_search_max_level,
    )
