...
from retrieval.vector_stores.azure_ai_search import AzureAISearchVectorStore
from retrieval.vector_stores.cosmosdb import CosmosDBVectorStore
from retrieval.vector_stores.lancedb import LanceDBVectorStore

if TYPE_CHECKING:
    from collections.abc import Callable

    from retrieval.config.models.vector_store_schema_config import (
