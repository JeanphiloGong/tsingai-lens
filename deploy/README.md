...
curl -fsSL https://raw.githubusercontent.com/JeanphiloGong/tsingai-lens/main/deploy/install.sh \
  | sh -s -- --version v0.12.22 --ref v0.12.22
```
...
Edit `backend.env` before the first start to create the initial login
user:
