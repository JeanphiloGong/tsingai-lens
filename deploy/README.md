...
curl -fsSL https://raw.githubusercontent.com/JeanphiloGong/tsingai-lens/main/deploy/install.sh \
  | sh -s -- --version v0.12.12 --ref v0.12.12
```
...
Edit `backend.env` before the first v0.12.12 start to create the initial login
user:
