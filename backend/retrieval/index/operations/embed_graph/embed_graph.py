...
from retrieval.index.operations.embed_graph.embed_node2vec import embed_node2vec
from retrieval.index.operations.embed_graph.typing import (
    NodeEmbeddings,
)
from retrieval.index.utils.stable_lcc import stable_largest_connected_component
