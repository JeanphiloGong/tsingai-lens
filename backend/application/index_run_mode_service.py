...
def _resolve_vector_store_path(config: Any, vector_store_config: dict[str, Any]) -> Path | None:
...
def _required_vector_store_tables(config: Any, vector_store_config: dict[str, Any]) -> list[str]:
    embed_text = _get_attr(config, "embed_text")
