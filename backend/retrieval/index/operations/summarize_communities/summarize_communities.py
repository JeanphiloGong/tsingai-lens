...
from retrieval.index.operations.summarize_communities.utils import (
    get_levels,
)
from retrieval.index.utils.derive_from_rows import derive_from_rows
from retrieval.logger.progress import progress_ticker
...
def load_strategy(
    ...
    match strategy:
        case CreateCommunityReportsStrategyType.graph_intelligence:
            from retrieval.index.operations.summarize_communities.strategies import (
