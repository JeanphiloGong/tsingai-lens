...
from retrieval.config.enums import NounPhraseExtractorType
from retrieval.config.models.extract_graph_nlp_config import TextAnalyzerConfig
from retrieval.index.operations.build_noun_graph.np_extractors.base import (
    BaseNounPhraseExtractor,
)
from retrieval.index.operations.build_noun_graph.np_extractors.cfg_extractor import (
    CFGNounPhraseExtractor,
)
from retrieval.index.operations.build_noun_graph.np_extractors.regex_extractor import (
    RegexENNounPhraseExtractor,
)
from retrieval.index.operations.build_noun_graph.np_extractors.stop_words import (
    EN_STOP_WORDS,
)
from retrieval.index.operations.build_noun_graph.np_extractors.syntactic_parsing_extractor import (
