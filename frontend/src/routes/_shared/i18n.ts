	...
	en: {
		...
		research: {
			...
			understanding: {
				...
				reviewImportBody:
					'Paste edited decision-template JSONL rows. Dry-run checks the rows first; import writes only explicit accept, reject, or correct actions.',
				reviewImportReviewer: 'Reviewer',
				reviewImportTextareaLabel: 'Reviewed JSONL rows',
				reviewImportTextareaPlaceholder:
					'Paste one JSON object per line from the decision template after review.',
	...
	zh: {
		...
		research: {
			...
			understanding: {
				...
				reviewImportBody:
					'粘贴编辑后的决策模板 JSONL。先 dry-run 检查；正式导入只写入明确的 accept、reject 或 correct。',
				reviewImportReviewer: '复核人',
				reviewImportTextareaLabel: '已复核 JSONL 行',
				reviewImportTextareaPlaceholder: '从决策模板中粘贴专家复核后的 JSON，每行一个对象。',
