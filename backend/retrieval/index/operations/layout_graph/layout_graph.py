...
from retrieval.index.operations.embed_graph.typing import NodeEmbeddings
from retrieval.index.operations.layout_graph.typing import GraphLayout
...
def _run_layout(
    ...
    if enabled:
        from retrieval.index.operations.layout_graph.umap import (
            run as run_umap,
        )
    ...
    from retrieval.index.operations.layout_graph.zero import (
        run as run_zero,
    )
