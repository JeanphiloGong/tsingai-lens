...
from retrieval.prompt_tune.defaults import MAX_TOKEN_COUNT, PROMPT_TUNING_MODEL_ID
from retrieval.prompt_tune.generator.community_report_rating import (
    generate_community_report_rating,
)
from retrieval.prompt_tune.generator.community_report_summarization import (
    create_community_summarization_prompt,
)
from retrieval.prompt_tune.generator.community_reporter_role import (
    generate_community_reporter_role,
)
from retrieval.prompt_tune.generator.domain import generate_domain
from retrieval.prompt_tune.generator.entity_relationship import (
    generate_entity_relationship_examples,
)
from retrieval.prompt_tune.generator.entity_summarization_prompt import (
    create_entity_summarization_prompt,
)
from retrieval.prompt_tune.generator.entity_types import generate_entity_types
from retrieval.prompt_tune.generator.extract_graph_prompt import (
    create_extract_graph_prompt,
)
from retrieval.prompt_tune.generator.language import detect_language
from retrieval.prompt_tune.generator.persona import generate_persona
from retrieval.prompt_tune.loader.input import load_docs_in_chunks
...
async def generate_indexing_prompts(
    ...
    chunk_size: PositiveInt = retrieval_config_defaults.chunks.size,
    overlap: Annotated[
        int, annotated_types.Gt(-1)
    ] = retrieval_config_defaults.chunks.overlap,
