...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      eyebrow: 'Workspace',
      title: 'Collections',
      lead: 'Start from collections, then move through files, tasks, workspace, protocol, and graph outputs.',
    ...
    overview: {
      ...
      lead: 'Use the workspace summary to see file readiness, task progress, and enabled outputs.',
    ...
    steps: {
      ...
      lead: 'Review extracted steps in collection order and filter by paper or block type.',
      paperIdLabel: 'Paper ID',
      paperIdPlaceholder: 'Optional paper filter',
  ...
  zh: {
    ...
    home: {
      eyebrow: '工作区',
      title: '集合',
      lead: '从集合开始，依次进入文件、任务、工作区、protocol 和图谱结果。',
      primaryAction: '创建集合',
      emptyTitle: '暂无集合',
    ...
    steps: {
      title: 'Protocol 步骤',
      lead: '按集合顺序查看抽取出的步骤，并按论文或 block 类型过滤。',
      paperIdLabel: '论文 ID',
      paperIdPlaceholder: '可选论文过滤',
