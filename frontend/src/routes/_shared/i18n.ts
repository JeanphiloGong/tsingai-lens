...
const translations: Record<Language, Translations> = {
	en: {
		...
		researchAgent: {
			...
			capability: {
				...
				activityCompletedOne: 'Research action completed',
				activityCompletedMany: '{count} research actions completed',
				activityInProgressOne: 'Research action in progress',
				activityInProgressMany: '{count} research actions in progress',
				activityPendingOne: 'Research action prepared',
				activityPendingMany: '{count} research actions prepared',
				activityFailedOne: 'Research action needs attention',
				activityFailedMany: '{count} research actions need attention',
				...
				confirmObjective: 'Research question confirmation',
				deriveObjective: 'Derive follow-up objective',
				...
				tableContinuation:
					'This table is shown in a bounded window; ask the Agent to continue with the next rows before treating it as complete.',
				tableSummary: '{rows} data rows · {columns} columns',
				...
				findingDraftReady: 'Finding draft is ready for researcher review',
				evidenceDraftReady: 'Source-grounded Evidence draft is ready for review',
				evidenceDraftTransient:
					'This is a transient draft; it is not published Evidence until you approve the write.',
				findingDraftTransient:
					'This is a transient Finding draft; Lens must validate its Evidence bindings before publication.',
				...
				objectiveConfirmed: 'Research question confirmed without starting analysis',
				derivedDraftCount: '{count} follow-up objective draft(s)',
				researchPlanDraftReady: 'Research plan draft is ready for review',
				researchPlanSaved: 'Research plan saved for researcher review',
				qualitySummary:
					'{findings} findings · {evidence} evidence · {gaps} scientific gaps · {failures} technical failures',
				qualityFindingAvailable: 'Finding available',
				qualityFindingWithGaps: 'Finding available with review gaps',
				qualityScientificAbstention: 'Analysis abstained scientifically',
				qualityNoGroundedEvidence: 'No grounded evidence',
				qualityNotAnalyzed: 'Not analyzed',
				qualityDetails:
					'{findings} findings · {evidence} evidence · {gaps} scientific gaps · {failures} technical failures',
				previousResultRetained:
					'A previous published result is retained while a newer run has failed.',
				derivationBasisShown: 'The drafts retain {count} validated basis record(s).',
				tablePreview: 'Complete Source table',
				sourcePreview: 'Complete Source content',
				...
				analysisNotStarted: 'Evidence analysis has not started.',
				analysisQueued: 'Evidence analysis is waiting to start.',
			...
			researchProcess: {
				label: 'Literature analysis stages',
				sourceUnderstanding: 'Prepare paper contents',
				paperClassification: 'Assess paper type and role',
				scopeScreening: 'Identify materials, variables, and results',
				objectiveFormation: 'Synthesize candidate research questions',
				queued: 'Not started',
				running: 'In progress',
				completed: 'Completed',
				failed: 'Not completed',
				skipped: 'Not run',
				currentPaper: 'Paper being reviewed',
				documentProgress: '{document} · paper {current} of {total}',
				notStartedSummary: 'Literature analysis has not started.',
				queuedSummary: 'Literature analysis is waiting to start.',
				runningSummary: 'Literature analysis is in progress.',
				completedSummary:
					'Paper preparation and candidate research-question synthesis are complete.',
				partialSummary: 'Literature analysis is complete, but some content still needs review.',
				failedSummary: 'Literature analysis did not finish. Review the issue below.'
			},
			warnings: 'Warnings',
			...
			resource: {
				...
				source: 'Open exact Source',
				document: 'Open paper',
				analysis: 'Open analysis',
				researchPlan: 'Open research plan',
			...
			approval: {
				...
				confirmObjective: 'Approve confirmation',
				...
				publishResearchPlan: 'Approve and save research plan',
			...
			objectiveConfirmationRejected: 'The research question was not confirmed.',
		...
		research: {
			...
			evidenceMap: {
				...
				objectiveLabel: 'Published objective',
				loading: 'Loading published evidence relationships...',
				errorTitle: 'Evidence map unavailable',
				retry: 'Try again',
				emptyTitle: 'No published evidence maps yet',
				emptyBody:
					'Confirm and analyze a research objective before inspecting its evidence relationships.',
				openObjectives: 'Open research objectives',
				mapLabel: 'Published objective evidence map',
				coverageLabel: 'Evidence map coverage',
				flowLabel: 'Objective to paper evidence relationships',
				directEvidencePapers: 'papers with direct evidence',
				findingCount: 'Findings',
				evidenceCount: 'Evidence records',
				sourceCount: 'exact Sources',
				evidenceStatusLabel: 'Evidence status distribution',
				statusCount: '{status}: {count}',
				failedPaperOne: '{count} failed paper',
				failedPaperMany: '{count} failed papers',
				partialCoverage: 'Failed papers are coverage gaps, not contradictory scientific evidence.',
				unlinkedEvidence: '{count} Evidence record(s) are not used by a published Finding.',
				objectiveColumn: 'Objective',
				findingsColumn: 'Findings',
				evidenceColumn: 'Evidence',
				sourcesColumn: 'Sources',
				papersColumn: 'Papers',
				traceTitle: 'Finding evidence chains',
				traceLead: 'Published conclusions with confirming, challenging, and contextual Evidence.',
				linkedEvidenceCount: '{count} linked evidence',
				findingNumber: 'Finding {number}',
				noLinkedEvidence: 'No linked Evidence was published for this Finding.',
				unlinkedTitle: 'Evidence still needing review',
				unlinkedLead: 'These records were inspected but were not used in a published Finding.',
				paperCoverageTitle: 'Paper coverage',
				material: 'Material',
				variables: 'Variables',
				outcomes: 'Outcomes',
				certainty: '{value} certainty',
				noFindings: 'The published analysis abstained from making a Finding.',
				supports: 'Supports',
				contradicts: 'Contradicts',
				contextualizes: 'Contextualizes',
				statusComparable: 'Comparable evidence',
				statusAssociationOnly: 'Association only',
				statusDescriptive: 'Descriptive evidence',
				statusNeedsContext: 'Needs same-paper context',
				statusNonComparable: 'Not directly comparable',
				statusExtractionFailed: 'Extraction failed',
				statusUnknown: 'Inspected evidence',
				direction: {
					increase: 'Increase',
					decrease: 'Decrease',
					improve: 'Improve',
				...
				attribution: {
					isolated_effect: 'Isolated effect',
				...
				conditionBoundary: 'different conditions',
				pages: 'Page {pages} · open exact Source',
				openSource: 'Open exact Source',
				paperAnalyzed: 'Analyzed',
				paperExcluded: 'Excluded',
				paperFailed: 'Coverage failed'
			},
			state: {
				empty: 'Empty',
				processing: 'Processing',
			...
			documents: {
				...
				allPaperTypes: 'All paper types',
				hasWarnings: 'Has parsing warnings',
				...
				filterEmptyBody: 'No papers match the current search and filters.',
		...
		overview: {
			...
			currentModel: {
				...
				export: {
					title: 'Export collection materials',
					lead: 'Download selected original papers and their manifest for review or failure reproduction.',
					selectAll: 'Select all papers',
					selectDocument: 'Select paper for archive',
					selected: '{count} paper(s) selected',
					selectionHelp: 'Select at least one paper to create an archive.',
					selectionLimit: 'Select no more than 100 papers per archive.',
					downloadArchive: 'Download source ZIP',
					downloading: 'Preparing source ZIP...',
					archiveDownloaded: 'Source archive downloaded.',
					findingTitle: 'Finding exports',
					findingLead:
						'Download collection-level labels for review, training, or expert gold drafting.',
					downloadFindingJson: 'Download Finding JSON',
					downloadFindingJsonl: 'Download Finding JSONL',
					downloadGoldDraft: 'Download gold draft',
					findingDownloading: 'Preparing Finding export...',
					findingDownloaded: 'Finding export downloaded.'
				},
		...
		graph: {
			...
			layout: {
				layered: 'Layered evidence layout',
			...
			detail: {
				title: 'Graph object detail',
				empty: 'Click a graph node to inspect its source and comparison details.',
				clear: 'Clear',
		...
		error: {
			...
			authSessionChanged: 'Your sign-in session changed. Please sign in again.',
	...
	zh: {
		...
		researchAgent: {
			...
			capability: {
				activity: '研究活动',
				activityCompletedOne: '已完成 {count} 项研究操作',
				activityCompletedMany: '已完成 {count} 项研究操作',
				activityInProgressOne: '有 {count} 项研究操作正在进行',
				activityInProgressMany: '有 {count} 项研究操作正在进行',
				activityPendingOne: '已准备 {count} 项研究操作',
				activityPendingMany: '已准备 {count} 项研究操作',
				activityFailedOne: '有 {count} 项研究操作需要处理',
				activityFailedMany: '有 {count} 项研究操作需要处理',
				artifact: '研究结果',
				requested: '请求执行{name}',
				succeeded: '{name}已完成',
				queued: '{name}已启动',
				...
				tableSummary: '{rows} 行数据 · {columns} 列',
				...
				findingDraftReady: 'Finding 草稿已准备好，等待研究者审阅',
				evidenceDraftReady: '有原文依据的 Evidence 草稿已准备好，等待审阅',
				evidenceDraftTransient: '这是临时草稿；确认写入前不会成为已发布的 Evidence。',
				findingDraftTransient: '这是临时 Finding 草稿；发布前 Lens 仍会核对它引用的 Evidence。',
				...
				objectiveConfirmed: '研究问题已确认，尚未启动分析',
				derivedDraftCount: '{count} 个后续研究目标草稿',
				researchPlanDraftReady: '研究方案草稿已准备好，等待审阅',
				researchPlanSaved: '研究方案已保存，等待研究者审阅',
				qualitySummary:
					'{findings} 条 Finding · {evidence} 条 Evidence · {gaps} 个科学缺口 · {failures} 个技术失败',
				qualityFindingAvailable: '已有 Finding',
				qualityFindingWithGaps: '已有 Finding，但仍有审阅缺口',
				qualityScientificAbstention: '分析选择科学性暂缓结论',
				qualityNoGroundedEvidence: '没有有原文依据的证据',
				qualityNotAnalyzed: '尚未分析',
				qualityDetails:
					'{findings} 条 Finding · {evidence} 条 Evidence · {gaps} 个科学缺口 · {failures} 个技术失败',
				previousResultRetained: '较新的运行失败，之前已发布的结果仍被保留。',
				derivationBasisShown: '草稿保留了 {count} 条已验证的形成依据。',
				tablePreview: '完整原文表格',
				sourcePreview: '完整原文内容',
				sourceReference: '原文位置',
				sourceKind: '原文类型',
				evidenceRole: 'Evidence 角色',
				...
				analysisNotStarted: '尚未开始证据分析。',
				analysisQueued: '证据分析已排队，尚未开始。',
			...
			researchProcess: {
				label: '文献分析阶段',
				sourceUnderstanding: '整理论文内容',
				paperClassification: '判断论文类型与研究用途',
				scopeScreening: '识别材料、变量与结果',
				objectiveFormation: '归纳候选研究问题',
				queued: '尚未开始',
				running: '进行中',
				completed: '已完成',
				failed: '未完成',
				skipped: '未执行',
				currentPaper: '当前正在处理的论文',
				documentProgress: '{document} · 第 {current}/{total} 篇',
				notStartedSummary: '尚未开始分析这个文献集合。',
				queuedSummary: '文献分析已排队，尚未开始。',
				runningSummary: '正在分析这个文献集合。',
				completedSummary: '文献整理与候选研究问题归纳已完成。',
				partialSummary: '文献分析已完成，但部分内容仍需复核。',
				failedSummary: '文献分析未完成，请查看下方问题。'
			},
			warnings: '警告',
			resources: '引用记录',
			resource: {
			...
			approval: {
				...
				researchPlanBody:
					'保存研究方案草稿前，请核对它引用的 Finding 和 Evidence 快照。保存后仍会作为研究者可审阅的草稿。',
				agentObjectiveAnalysisBody:
			...
			objectiveConfirmationRejected: '已取消确认研究问题。',
		...
		research: {
			...
			evidenceMap: {
				...
				errorTitle: '证据关系图不可用',
				retry: '重试',
				emptyTitle: '暂无已发布证据关系图',
				emptyBody: '请先确认并分析一个研究目标，再查看它的证据关系。',
				openObjectives: '打开研究目标',
				mapLabel: '已发布研究目标证据关系图',
				coverageLabel: '证据关系图覆盖情况',
				flowLabel: '研究目标到论文的证据关系',
				directEvidencePapers: '篇论文有直接证据',
				findingCount: '条 Findings',
				evidenceCount: '条 Evidence',
				sourceCount: '个精确 Sources',
				evidenceStatusLabel: 'Evidence 状态分布',
				statusCount: '{status}：{count} 条',
				failedPaperOne: '{count} 篇论文提取失败',
				failedPaperMany: '{count} 篇论文提取失败',
				partialCoverage: '失败论文表示覆盖缺口，不表示科学结论相互矛盾。',
				unlinkedEvidence: '有 {count} 条 Evidence 未被已发布 Finding 使用。',
				objectiveColumn: '研究目标',
				findingsColumn: '研究发现',
				evidenceColumn: '证据',
				sourcesColumn: '原始来源',
				papersColumn: '论文',
				traceTitle: '按 Finding 核查证据链',
				traceLead: '汇总已发布结论及其支持、不一致和条件性 Evidence。',
				linkedEvidenceCount: '{count} 条关联证据',
				findingNumber: 'Finding {number}',
				noLinkedEvidence: '这条 Finding 还没有已发布的关联 Evidence。',
				unlinkedTitle: '仍需复核的 Evidence',
				unlinkedLead: '这些记录已被检查，但尚未用于已发布的 Finding。',
				paperCoverageTitle: '论文覆盖情况',
				material: '材料',
				variables: '变量',
				outcomes: '结果',
				certainty: '确定性 {value}',
				noFindings: '已发布分析选择不形成 Finding。',
				supports: '支持证据',
				contradicts: '不一致证据',
				contextualizes: '条件与机制',
				statusComparable: '可直接比较',
				statusAssociationOnly: '仅能说明关联',
				statusDescriptive: '描述性证据',
				statusNeedsContext: '需要同论文上下文',
				statusNonComparable: '不可直接比较',
				statusExtractionFailed: '提取失败',
				statusUnknown: '已检查证据',
				direction: {
					increase: '增加',
					decrease: '降低',
				...
				attribution: {
					...
					joint_effect: '联合变化',
					association_only: '仅能说明关联',
					descriptive_only: '仅作描述',
					not_attributable: '不可归因'
				},
				conditionBoundary: '条件不同',
				pages: '第 {pages} 页 · 打开精确 Source',
				openSource: '打开精确 Source',
				paperAnalyzed: '已分析',
				paperExcluded: '已排除',
				paperFailed: '覆盖失败'
			},
			...
			documents: {
				...
				filterEmptyBody: '没有论文符合当前搜索和筛选条件。',
		...
		overview: {
			...
			currentModel: {
				...
				export: {
					...
					selectionHelp: '至少选择一篇论文后才能创建归档。',
					selectionLimit: '每个归档最多选择 100 篇论文。',
					downloadArchive: '下载原始论文 ZIP',
					downloading: '正在准备原始论文 ZIP...',
					archiveDownloaded: '原始论文归档已下载。',
					findingTitle: 'Finding 数据导出',
					findingLead: '下载集合级标注数据，用于复核、训练或整理专家金标草稿。',
					downloadFindingJson: '下载 Finding JSON',
					downloadFindingJsonl: '下载 Finding JSONL',
					downloadGoldDraft: '下载金标草稿',
					findingDownloading: '正在准备 Finding 导出...',
					findingDownloaded: 'Finding 导出已下载。'
				},
		...
		error: {
			...
			authSessionChanged: '登录状态已发生变化，请重新登录。',
