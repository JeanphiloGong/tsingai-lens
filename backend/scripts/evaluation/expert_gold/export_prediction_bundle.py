...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "published Findings and ObjectiveEvidence into the bundle."
        ),
    )
    ...
    *,
    ...
    if fact_source == "objective_first":
        ...
        evidence = _raw_records(
            records_by_artifact["objective_evidence"],
            "objective_evidence",
        )
        uncertainties = [
            {
    ...
    bundle: dict[str, Any] = {
        ...
        "global_notes": [],
        "objective_evidence": _raw_records(
            records_by_artifact["objective_evidence"],
            "objective_evidence",
        ),
        "objective_findings": _raw_records(
            records_by_artifact["objective_findings"],
            "objective_findings",
        ),
