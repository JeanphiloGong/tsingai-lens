...
This family owns backend plans for downstream surfaces derived from Source or
Core outputs.

## Reading Order

- [`graph-surface-plan.md`](graph-surface-plan.md)
  Retained graph-surface hardening background and lineage
...
Keep graph, protocol, and retired derived-surface cleanup here. Report and
material-review-report execution plans are retired; use ResearchUnderstanding
and evidence audit for claim synthesis instead.
