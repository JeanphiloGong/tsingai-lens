...
from retrieval.config.models.chunking_config import ChunkingConfig, ChunkStrategyType
from retrieval.index.operations.chunk_text.typing import (
    ChunkInput,
    ChunkStrategy,
)
from retrieval.logger.progress import ProgressTicker, progress_ticker
...
def load_strategy(strategy: ChunkStrategyType) -> ChunkStrategy:
    ...
    match strategy:
        case ChunkStrategyType.tokens:
            from retrieval.index.operations.chunk_text.strategies import run_tokens

            return run_tokens
        case ChunkStrategyType.sentence:
            # NLTK
            from retrieval.index.operations.chunk_text.bootstrap import bootstrap
            from retrieval.index.operations.chunk_text.strategies import run_sentences
