...
const translations: Record<Language, Translations> = {
	en: {
		...
		research: {
			...
			understanding: {
				...
				objectiveBody:
					'Effect rows, evidence, contexts, and expert review controls projected from the objective evidence workspace.',
				materialBody:
					'Effect rows, evidence, contexts, and expert review controls projected from the material research view.',
				...
				claimDetail: 'Effect review',
				evidenceStripHint: 'Selected effect evidence is highlighted.',
				...
				effectMap: 'Effect map',
				effectDetail: 'Effect review',
				effectDirection: 'Effect',
				...
				noFeedback: 'No feedback has been recorded for this effect.',
				...
				noEffects: 'No effect rows are available yet.',
				noRelations: 'No relations are available yet.',
				noEvidence: 'No evidence references are available yet.',
				noContexts: 'No context records are linked to this effect.',
				noSelectedClaim: 'Select an effect row to review its evidence and context.',
				noSelectedEffect: 'Select an effect row to review its evidence and context.',
	...
	zh: {
		...
		research: {
			...
			understanding: {
				title: '研究理解',
				objectiveBody: '从该研究目标的证据工作区投影出的效应行、证据、上下文和专家复核控件。',
				materialBody: '从该材料 research-view 投影出的效应行、证据、上下文和专家复核控件。',
				summary: '研究理解摘要',
				claims: '发现',
				relationsLabel: '关系',
				evidenceRefs: '证据',
				...
				noRelations: '暂未得到关系。',
				noEvidence: '暂未得到证据引用。',
				noContexts: '当前效应暂未关联上下文记录。',
				noSelectedClaim: '请选择一条效应行查看证据和上下文。',
				noSelectedEffect: '请选择一条效应行查看证据和上下文。',
