...
const translations: Record<Language, Translations> = {
  en: {
    ...
    overview: {
      ...
      uploadAfterBody: 'Once processing finishes, this collection unlocks three core result areas.',
      uploadAfterSteps: 'Review extracted procedures from the papers',
      uploadAfterSop: 'Generate and review a draft experiment plan',
      uploadAfterGraph: 'Use graph view to inspect relationships and evidence structure',
      ...
      resultsLead: 'After processing, start with paper steps, then move into the draft plan or graph.',
      resultsFlow:
        'Paper steps show what the source papers actually did. Draft plan shows the experiment plan the system can assemble from those steps.',
    ...
    sop: {
      ...
      paperIdsLabel: 'Only use these papers (optional)',
      paperIdsPlaceholder: 'Optional, comma separated paper IDs',
  ...
  zh: {
    ...
    overview: {
      ...
      resultsTitle: '可查看结果',
      resultsLead: '处理完成后，先看论文步骤，再进入方案草案或图谱。',
      resultsFlow: '论文步骤告诉你论文里实际做了什么；方案草案告诉你基于这些步骤可以先审阅什么实验方案。',
    ...
    sop: {
      ...
      targetPropertiesPlaceholder: 'mechanical, thermal',
      paperIdsLabel: '只用这些论文（可选）',
      paperIdsPlaceholder: '可选，逗号分隔的论文 ID',
      maxStepsLabel: '最大步骤数',
      submit: '生成方案草案',
      generating: '方案草案生成中...',
      loadExample: '载入示例目标',
