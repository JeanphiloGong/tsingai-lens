...
const translations: Record<Language, Translations> = {
  ...
  zh: {
    ...
    overview: {
      ...
      statusTitle: '当前状态',
      statusLead: '这里集中告诉你这个集合现在走到哪一步。',
      statusFiles: '已上传文件',
      statusLatestTask: '最近任务',
      statusStage: '当前阶段',
      statusProgress: '当前进度',
      statusUpdated: '最近更新时间',
      statusArtifactsTitle: '已解锁内容',
      statusArtifactsEmpty: '还没有可显示的产物状态，先上传论文并开始处理。',
      resultsTitle: '可查看结果',
      resultsLead: '工作区主流程只保留三个结果入口：步骤、SOP 和图谱。',
      resultStepsLead: '浏览抽取出的实验步骤，并在这个页面里搜索动作和条件。',
      resultSopLead: '基于已有步骤生成可审阅的实验方案草案。',
      resultGraphLead: '用图谱回看实体关系和证据结构。',
      resultLocked: '完成处理后解锁',
