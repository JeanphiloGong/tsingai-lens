...
const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      noteStats: 'Status and stats require collection metrics APIs.',
    ...
    overview: {
      ...
      metricNote: 'Metrics will appear when collection stats are available.',
