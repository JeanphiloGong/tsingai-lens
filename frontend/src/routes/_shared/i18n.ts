...
const translations: Record<Language, Translations> = {
	en: {
		...
		traceback: {
			...
			sourceReaderLead:
				'Parsed source blocks stay visible while you review extracted evidence chains.',
			...
			sectionCountLabel: 'Source blocks',
