...
from retrieval.index.operations.summarize_descriptions.typing import (
...
def load_strategy(strategy_type: SummarizeStrategyType) -> SummarizationStrategy:
    ...
    match strategy_type:
        case SummarizeStrategyType.graph_intelligence:
            from retrieval.index.operations.summarize_descriptions.graph_intelligence_strategy import (
