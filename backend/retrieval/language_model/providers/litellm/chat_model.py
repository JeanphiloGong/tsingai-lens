...
from retrieval.config.defaults import COGNITIVE_SERVICES_AUDIENCE
from retrieval.config.enums import AuthType
from retrieval.language_model.providers.litellm.request_wrappers.with_cache import (
    with_cache,
)
from retrieval.language_model.providers.litellm.request_wrappers.with_logging import (
    with_logging,
)
from retrieval.language_model.providers.litellm.request_wrappers.with_rate_limiter import (
    with_rate_limiter,
)
from retrieval.language_model.providers.litellm.request_wrappers.with_retries import (
    with_retries,
)
from retrieval.language_model.providers.litellm.types import (
...
if TYPE_CHECKING:
    ...
    from retrieval.language_model.response.base import ModelResponse as MR  # noqa: N817
