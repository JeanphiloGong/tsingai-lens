...
const translations: Record<Language, Translations> = {
	en: {
		...
		traceback: {
			...
			sourceReaderLead:
				'Parsed paper sections stay visible while you review extracted evidence chains.',
			...
			sourceSelectPromptBody:
				'Choose a result chain on the right to locate its supporting source context here.',
			...
			sourceLocatedBody: 'The best available source anchor is selected and highlighted below.',
	...
	zh: {
		...
		traceback: {
			...
			sourceReaderLead: '在核查右侧证据链时，左侧始终保留解析后的论文段落。',
			...
			sourceSelectPromptBody: '在右侧选择结果链后，这里会尝试定位对应的原文上下文。',
			...
			sourceLocated: '已定位原文',
			sourceLocatedBody: '当前已选择并高亮最可用的原文锚点。',
