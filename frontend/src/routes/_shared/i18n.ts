...
const translations: Record<Language, Translations> = {
  en: {
    ...
    overview: {
      ...
      artifactsTitle: 'Artifact readiness',
      artifactsLead: 'The workspace exposes which downstream views are safe to enter.',
      artifacts: {
        documents: 'Documents',
        graph: 'Graph',
        graphml: 'GraphML',
      ...
      activityLead: 'Recent runs and live progress stay in the workspace so users always know what the system is doing.',
      recentActivityTitle: 'Recent activity',
      latestTaskTitle: 'Latest task',
      latestTaskLead: 'Track the most recent indexing run and the capabilities it unlocked.',
      ...
      nextTrack: 'Track progress',
      nextTasks: 'Open tasks',
      nextSteps: 'Browse steps',
      nextSearch: 'Search protocol',
      nextSop: 'Generate SOP',
      nextGraph: 'Open graph',
      nextAdvanced: 'Open advanced',
  ...
  zh: {
    ...
    overview: {
      ...
      artifactsTitle: '产物就绪度',
      artifactsLead: '这里会告诉你哪些下游页面已经可以进入。',
      artifacts: {
        documents: '文档',
        graph: '图谱',
        graphml: 'GraphML',
      ...
      primaryActionHelperUpload: '先把源论文放进集合。文件、任务和结果都会挂在这个集合下面。',
      primaryActionHelperProcess: '文件已经就绪，现在运行索引以解锁步骤、SOP 和图谱。',
      primaryActionHelperTrack: '索引正在运行，留在这里即可看到阶段变化和最近活动。',
      primaryActionHelperResults: '核心产物已经就绪，可以先审阅步骤，也可以直接进入 SOP 草案。',
      filesLead: '在这里上传源论文。主流程不再需要单独的“文档”页。',
      filesCount: '当前集合共有 {count} 个文件',
      activityLead: '最近运行和实时进度都留在工作区里，避免用户不知道系统在做什么。',
      recentActivityTitle: '最近活动',
      latestTaskTitle: '最近任务',
      latestTaskLead: '跟踪最近一次索引运行以及它解锁的能力。',
      startIndex: '启动索引',
      indexNoFiles: '请至少上传一个文件后再启动索引任务。',
      indexStarted: '任务已启动：{taskId}',
      capabilitiesTitle: '工作区能力',
      capabilities: {
        graph: '图谱查看',
        steps: 'Protocol 步骤',
        search: 'Protocol 检索',
      ...
      noTasks: '这个集合还没有执行过索引任务。',
      nextActionsTitle: '下一步',
      nextUpload: '上传论文',
      nextTrack: '查看进度',
      nextTasks: '打开任务',
      nextSteps: '查看步骤',
      nextSearch: '检索 protocol',
      nextSop: '生成 SOP',
      nextGraph: '打开图谱',
      nextAdvanced: '打开高级区',
    ...
    search: {
      title: 'Protocol 检索',
      lead: '按动作、材料和条件检索抽取出的 protocol steps。',
      inputLabel: '检索词',
    ...
    steps: {
      title: 'Protocol 步骤',
      lead: '在一个页面里同时检索和浏览抽取出的 protocol steps，再直接进入 SOP。',
      paperIdLabel: '论文 ID',
      paperIdPlaceholder: '可选论文过滤',
      blockTypeLabel: 'Block 类型',
      blockTypePlaceholder: '可选 block 类型',
      limitLabel: '返回条数',
      searchHelper: '留空检索词时，会直接浏览完整步骤列表。',
      loading: '步骤加载中...',
      submit: '刷新步骤',
      resultTitle: '步骤列表',
