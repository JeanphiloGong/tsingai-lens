...
const translations: Record<Language, Translations> = {
  en: {
    ...
    sop: {
      ...
      notReadyError: 'Finish processing and protocol artifact generation before generating an SOP.',
      notReadyBody:
        'This collection is still missing protocol artifacts. Return to the workspace, complete processing, and then generate the SOP draft.',
      backToWorkspace: 'Back to workspace',
  ...
  zh: {
    ...
    sop: {
      ...
      generating: 'SOP 生成中...',
      errorGoal: '请先填写目标。',
      notReadyError: '请先完成处理并生成 protocol 产物，再生成 SOP。',
      notReadyBody: '当前集合还没有 protocol 产物。请先回到工作区完成处理，再来生成 SOP 草案。',
      backToWorkspace: '返回工作区',
      resultTitle: 'SOP 结果',
      viewSteps: '返回步骤页',
      objectiveTitle: '实验目标',
