	...
	en: {
		...
		research: {
			...
			understanding: {
				...
				datasetDownloadTrainingMessagesJsonl: 'Training messages JSONL',
				datasetDownloadTrainingTraceableJsonl: 'Traceable training JSONL',
				datasetDownloadCollectionTrainingJson: 'Collection training JSON',
				datasetDownloadCollectionTrainingJsonl: 'Collection training JSONL',
				datasetDownloadCollectionTrainingMessagesJsonl: 'Collection training messages JSONL',
				datasetDownloadCollectionTrainingTraceableJsonl:
				...
				datasetDownloadCollectionDecisionBoard: 'Collection decision board TSV',
				datasetDownloadCollectionAgentReviewPrompt: 'Collection agent review prompts',
				...
				datasetDownloadDecisionBoard: 'Decision board TSV',
				datasetDownloadAgentReviewPrompt: 'Agent review prompts',
				...
				reviewImportProgress:
					'{actionable} actionable row(s), {skipped} skipped row(s), {written} written.',
				reviewImportRequiresReviewer: 'Sign in as an expert reviewer before importing decisions.',
				reviewImportRows: 'Rows',
				reviewImportWritten: 'Written',
				...
				reviewImportScopeGateTitle: 'Expert satisfaction gate',
				reviewImportScopeGateStatus: 'Gate status: {status}.',
				reviewImportScopeGateCounts:
					'Actionable rows {actionable}, skipped rows {skipped}. Training export {trainingStatus}; protocol drafting {protocolStatus}.',
				...
				reviewLoopDownloadDecisionTemplate: 'Download decision template',
				reviewLoopDownloadDecisionBoard: 'Download decision board TSV',
				reviewLoopDownloadAgentReviewPrompt: 'Download agent review prompts',
				reviewLoopDownloadReviewPacket: 'Download review packet',
				...
				reviewLoopNextProtocolBlockers: 'Protocol blockers',
				...
				allDatasetUseStatuses: 'All uses',
				...
				crossPaperSynthesis: 'Cross-paper synthesis',
				synthesisAgreement: 'Agreement',
				synthesisConflict: 'Conflict',
				synthesisConditionDependent: 'Condition-dependent',
				synthesisInsufficientConfirmation: 'Insufficient confirmation',
				synthesisAgreementBody:
					'Independent papers report a comparable result in the same direction.',
				synthesisConflictBody:
					'Comparable direct results disagree; review supporting and opposing evidence.',
				synthesisConditionDependentBody:
					'The reported relationship changes with explicit material, process, or test conditions.',
				synthesisInsufficientConfirmationBody:
					'Only one paper currently provides a direct result, or the available papers are not independently comparable.',
				commonConditions: 'Shared applicability conditions',
				incomparableConditions: 'Conditions that prevent direct comparison',
				paperContributions: 'Paper contributions',
				paperContributionSupporting: 'Supporting',
				paperContributionConflicting: 'Opposing',
				paperContributionMixed: 'Mixed',
				paperContributionFallback: 'Paper {count}',
				...
				reviewDecisionHint: 'Review decision',
				reviewDecisionHintAcceptBlocked: 'Accept blocked',
				reviewDecisionHintVerifyFirst: 'Verify before accepting',
				reviewDecisionHintCorrectOrReject: 'Correct or reject',
				reviewDecisionHintAcceptAfterChecks: 'Accept after checks',
				reviewDecisionBlockedActions: 'Blocked actions',
				reviewDecisionWhyAcceptBlocked: 'Why accept is blocked',
				reviewDecisionRequiredChecks: 'Required checks',
				reviewDecisionBlockedMissing: 'Missing required fields: {items}',
				reviewDecisionBlockedRisks: 'Resolve review risks first: {items}',
				...
				curationSupportGrade: 'Curated evidence grade',
				curationStatement: 'Curated statement',
				curationVariables: 'Curated variables',
				curationMediators: 'Curated mechanism',
				curationOutcomes: 'Curated outcomes',
				curationDirection: 'Curated direction',
				curationScope: 'Curated conditions',
				curationEvidenceRefs: 'Curated evidence',
				curationContextRefs: 'Curated context',
				curationNoEvidenceRefs: 'No evidence is linked to this claim yet.',
				curationNoContextRefs: 'No context is linked to this claim yet.',
				curationNote: 'Curation note',
				curationReviewer: 'Curator',
				curationSubmit: 'Save curation',
				curationSubmitAndNext: 'Save curation and next',
				...
				reviewActions: 'Claim review actions',
				reviewQueuePosition: 'Review candidate {current} of {total}',
				quickAccept: 'Accept',
				quickAcceptAndNext: 'Accept and next',
				quickAcceptPaperLevel: 'Accept paper-level',
				quickAcceptPaperLevelAndNext: 'Accept paper-level and next',
				quickReviewAccept: 'Review accept',
				quickReviewAcceptAndNext: 'Review accept and next',
				quickAcceptSaving: 'Accepting...',
				quickReject: 'Reject',
			...
			goalWorkspace: {
				...
				askCopilot: 'Ask Copilot',
				experimentPlansEyebrow: 'Experiment planning',
				...
				experimentPlanContent: 'Plan content',
				experimentPlanDraft: 'Draft',
				experimentPlanReady: 'Ready for review',
				experimentPlanArchived: 'Archived',
				experimentPlanSave: 'Save edits',
				experimentPlanSaving: 'Saving...',
				experimentPlanProvenance: 'Experiment plan provenance',
				experimentPlanCopilotSource: 'Goal Copilot draft',
	...
	zh: {
		...
		research: {
			...
			understanding: {
				...
				datasetDownloadTrainingMessagesJsonl: '训练 messages JSONL',
				datasetDownloadTrainingTraceableJsonl: '可追溯训练 JSONL',
				datasetDownloadCollectionTrainingJson: '全集合训练 JSON',
				datasetDownloadCollectionTrainingJsonl: '全集合训练 JSONL',
				datasetDownloadCollectionTrainingMessagesJsonl: '全集合训练 messages JSONL',
				...
				datasetDownloadCollectionDecisionBoard: '全集合决策表 TSV',
				datasetDownloadCollectionAgentReviewPrompt: '全集合 agent 复核任务',
				...
				datasetDownloadDecisionBoard: '决策表 TSV',
				datasetDownloadAgentReviewPrompt: 'Agent 复核任务',
				...
				reviewImportAgentDraftOnly:
					'这看起来是 agent 复核草稿。专家需要在认可的行上设置 agent_review.human_confirmed=true，或把已确认的行从 skip 改成 accept、reject 或 correct 后才能导入。',
				...
				reviewImportRequiresReviewer: '需要使用专家账号登录后才能导入复核决策。',
				reviewImportRows: '行数',
				reviewImportWritten: '已写入',
				...
				reviewImportScopeGateTitle: '专家满意门禁',
				reviewImportScopeGateStatus: '门禁状态：{status}。',
				reviewImportScopeGateCounts:
					'可写入 {actionable} 行，跳过 {skipped} 行。训练导出 {trainingStatus}；实验方案草拟 {protocolStatus}。',
				...
				reviewLoopDownloadDecisionTemplate: '下载决策模板',
				reviewLoopDownloadDecisionBoard: '下载决策表 TSV',
				reviewLoopDownloadAgentReviewPrompt: '下载 Agent 复核任务',
				reviewLoopDownloadReviewPacket: '下载复核包',
				...
				reviewLoopNextProtocolBlockers: '方案阻塞项',
				coverageGaps: '覆盖缺口',
				coverageGapsBody:
				...
				crossPaperSynthesis: '跨文献综合判断',
				synthesisAgreement: '结果一致',
				synthesisConflict: '结果冲突',
				synthesisConditionDependent: '条件依赖',
				synthesisInsufficientConfirmation: '证据不足以相互确认',
				synthesisAgreementBody: '独立文献在可比条件下报告了方向一致的直接结果。',
				synthesisConflictBody: '可比的直接结果相互矛盾，需要同时核对支持与反驳证据。',
				synthesisConditionDependentBody: '该关系会随明确的材料、工艺或测试条件而变化。',
				synthesisInsufficientConfirmationBody:
					'当前只有一篇文献提供直接结果，或已有文献之间尚不能独立比较。',
				commonConditions: '共同适用条件',
				incomparableConditions: '不可直接比较的条件',
				paperContributions: '各文献贡献',
				paperContributionSupporting: '支持',
				paperContributionConflicting: '反驳',
				paperContributionMixed: '同时包含支持与反驳',
				paperContributionFallback: '文献 {count}',
				...
				reviewDecisionHint: '复核决策',
				reviewDecisionHintAcceptBlocked: '不能直接接受',
				reviewDecisionHintVerifyFirst: '先核验证据再接受',
				reviewDecisionHintCorrectOrReject: '需要校正或拒绝',
				reviewDecisionHintAcceptAfterChecks: '检查后可接受',
				reviewDecisionBlockedActions: '被阻止的操作',
				reviewDecisionWhyAcceptBlocked: '不能接受的原因',
				reviewDecisionRequiredChecks: '必须检查',
				reviewDecisionBlockedMissing: '缺少必要字段：{items}',
				reviewDecisionBlockedRisks: '先处理复核风险：{items}',
				reviewDecisionActions: {
					accept: '接受',
					reject: '拒绝',
					correct: '校正',
				...
				curationSupportGrade: '校正证据等级',
				curationStatement: '校正后的表述',
				curationVariables: '校正变量',
				curationMediators: '校正机制',
				curationOutcomes: '校正结果',
				curationDirection: '校正方向',
				curationScope: '校正适用条件',
				curationEvidenceRefs: '校正证据',
				curationContextRefs: '校正上下文',
				curationNoEvidenceRefs: '当前 Claim 暂未绑定证据。',
				curationNoContextRefs: '当前 Claim 暂未绑定上下文。',
				curationNote: '校正备注',
				curationReviewer: '校正人',
				curationSubmit: '保存校正',
				curationSubmitAndNext: '保存校正并下一条',
				curationSaving: '保存中...',
				...
				feedbackTitle: '专家反馈',
				reviewActions: 'Claim 复核操作',
				reviewQueuePosition: '待复核 {current} / {total}',
				quickAccept: '接受',
				quickAcceptAndNext: '接受并下一条',
				quickAcceptPaperLevel: '按单篇证据接受',
				quickAcceptPaperLevelAndNext: '按单篇证据接受并下一条',
				quickReviewAccept: '复核后接受',
				quickReviewAcceptAndNext: '复核后接受并下一条',
				quickAcceptSaving: '接受中...',
				quickReject: '拒绝',
				quickCorrect: '校正',
			...
			goalWorkspace: {
				...
				experimentPlanContent: '方案内容',
				experimentPlanDraft: '草稿',
				experimentPlanReady: '待复核',
				experimentPlanArchived: '已归档',
				experimentPlanSave: '保存修改',
				experimentPlanSaving: '保存中...',
				experimentPlanProvenance: '实验方案来源',
				experimentPlanCopilotSource: '目标助手方案草稿',
