	...
	en: {
		...
		research: {
			...
			objectiveWorkspace: {
				...
				evidenceUnitsTitle: 'Evidence units',
				evidenceUnitsBody:
					'Resolved evidence is grouped by what it contributes to the objective logic chain.',
	...
	zh: {
		...
		research: {
			...
			objectiveWorkspace: {
				...
				schema: '结构',
				noRoutes: '暂未生成证据路由。',
				evidenceUnitsTitle: '证据单元',
				evidenceUnitsBody: '已解析证据会按它在目标逻辑链中的作用分组。',
