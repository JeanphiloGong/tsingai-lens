...
const translations: Record<Language, Translations> = {
  en: {
    ...
    overview: {
      ...
      primaryActionHelperUpload: 'Start by adding source papers. Everything else in this collection depends on them.',
      ...
      primaryActionHelperTrack: 'Processing is running. Wait here if you want to monitor progress, then move into the main research views.',
      ...
      statusWorkflowLead: 'These stages describe what the collection is ready for, not just which backend files exist.',
      statusWorkflowEmpty: 'Workflow stages appear after upload and processing begin.',
      documentSummaryTitle: 'Paper mix',
      documentSummaryLead: 'See whether this collection is mostly experimental papers, reviews, or mixed sources.',
  ...
  zh: {
    ...
    overview: {
      ...
      primaryActionHelperProcess: '论文已经上传，现在开始处理，让系统先把这批材料整理成比较、证据和文档筛选结果。',
