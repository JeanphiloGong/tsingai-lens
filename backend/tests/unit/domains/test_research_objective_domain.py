...
def test_evidence_route_represents_source_units_and_extractability(
    source_kind: str,
    role: str,
    extractable: bool,
) -> None:
    route = EvidenceRoute.from_mapping(
        {
            "objective_id": "obj_1",
            "document_id": "P001",
...
def test_evidence_route_normalizes_false_string_and_invalid_role() -> None:
    route = EvidenceRoute.from_mapping(
        {
            "objective_id": "obj_1",
            "document_id": "P001",
